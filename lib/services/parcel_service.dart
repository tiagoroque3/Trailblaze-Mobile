...
class ParcelService {
  ...
  // Definição EPSG:3763 (ETRS89 / Portugal TM06)
  final proj3763 = Projection.add('EPSG:3763',
      '+proj=tmerc +lat_0=39.66825833333333 +lon_0=-8.133108333333334 '
      '+k=1 +x_0=0 +y_0=0 +ellps=GRS80 +units=m +no_defs');

  // Definição WGS84 (EPSG:4326)
  final proj4326 = Projection.WGS84;

  // Converte o ponto
  final point = proj3763.transform(proj4326, Point(x: x, y: y));
